      ...
      <section className="hero">
        ...
        <div style={{ position: "relative", zIndex: 2, display: "flex", flexDirection: "column", alignItems: "center" }}>
          ...
          <div className="hero-actions anim-3">
            <Link href="/docs" className="btn-primary" style={{ border: "none", cursor: "pointer", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 8 }}>
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          <Reveal>
            ...
            <div className="hero-actions" style={{ marginBottom: 0 }}>
              <Link href="/docs" className="btn-primary" style={{ fontSize: 15, padding: "14px 30px", border: "none", cursor: "pointer", textDecoration: "none", display: "inline-flex", alignItems: "center" }}>
                Interactive v2 Docs
              </Link>
